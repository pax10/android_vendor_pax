...
# Inherit pax common_tablet bits
$(call inherit-product, vendor/pax/configs/common_tablet.mk)

# Grouper Overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/pax/overlay/grouper
...
PRODUCT_COPY_FILES += \
    vendor/pax/prebuilt/bootanimation/bootanimation-grouper.zip:system/media/bootanimation.zip
