...
$(call inherit-product, vendor/raumzero/config/common_tablet.mk)
# Inherit
$(call inherit-product, vendor/raumzero/config/common.mk)

PRODUCT_COPY_FILES += \
    vendor/raumzero/prebuilt/common/media/bootanimation-tvdpi.zip:system/media/bootanimation.zip
